                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="coloumn px-2">
                                ...
                                @enderror
                                <div class="form-group col-md-15"> <label class="form-control-label">Alamat pengiriman</label> <input type="text" id="cname" name="shipping_address" placeholder="Johnny Dodol"> 
                                </div>

                                @error('postal_code')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                <div class="form-group col-md-15"> <label class="form-control-label">Kode pos</label> <input type="text" id="cnum" name="postal_code" placeholder="065478"> 
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 mt-2">
                            ...
                            <a href="{{ route('cart') }}" class="btn btn-danger"><i class="fa fa-angle-left"></i> Kembali</a>
                            <button type="submit" class="btn-block btn-blue"> <span> <span id="checkout">Buat faktur</span> <span id="check-amt">{{ $total_price_rupiah }}</span> </span> </button>
                        </div>
                    </div>
                </form>
            </div>
